...
try {
  ...
  console.log("Loaded scripts:", Object.keys(scripts)); // Debugging line to confirm loading scripts
} catch (err) {
...
app.get('/script/api/:scriptName', (req, res) => {
  ...
  console.log("Requested scriptName:", scriptName); // Debugging
...
// Catch-all route for all other paths (except /script/api/:scriptName)
app.get('*', (req, res) => {
